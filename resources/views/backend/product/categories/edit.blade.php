                ...
                <div class="card-body p-0">
                    ...
                    <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select disabled class="select2 form-control aiz-selectpicker" name="parent_id"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{ translate('Twitter Description') }}</label>
                            <div class="col-md-9">
                                <textarea name="twitter_description" rows="5" class="form-control">{{ $category->getTranslation('twitter_description', $lang) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
