...
<div class="row">
    <div class="col-lg-10 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{ route('news.store') }}" method="POST">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('News Title')}}"  id="title" name="title" class="form-control"  value="{{ old('title') }}" >
                            @error('title')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Arabic News Title')}}" id="ar_title" name="ar_title"  dir="rtl"  value="{{ old('ar_title') }}" class="form-control" >
                            @error('ar_title')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="news_date" id="news_date" placeholder="YYYY-MM-DD" class="form-control" value="{{ old('news_date') }}" autocomplete="off">
                            @error('news_date')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
