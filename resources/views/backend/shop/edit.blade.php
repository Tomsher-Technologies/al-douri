...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <h5 class="mb-0 h6">{{ translate('Edit Shop Details') }}</h5>
    </div>
    ...
    <div class="col-lg-6 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form id="formMap" action="{{ route('admin.shops.update', $shops[0]->id) }}" method="POST">
                    @csrf
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Name In English') }}" id="name" name="name"
                                class="form-control"  value="{{ old('name',$shops[0]->name) }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Name In Arabic') }}" id="name_ar" name="name_ar"
                                class="form-control"   value="{{ old('name_ar',$shops[0]->name_ar) }}"> 
                            @error('name_ar')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Phone') }}" id="phone" name="phone"  value="{{ old('phone',$shops[0]->phone) }}"
                                class="form-control" >
                            @error('phone')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Email Address') }}" id="email"  value="{{ old('email',$shops[0]->email) }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="address" id="address" cols="30" rows="3"
                                placeholder="{{ translate('Address In English') }}" >{{ old('address',$shops[0]->address) }}</textarea>
                            @error('address')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="address_ar" id="address_ar" cols="30" rows="3"
                                placeholder="{{ translate('Address In Arabic') }}" >{{ old('address_ar',$shops[0]->address_ar) }}</textarea>
                            @error('address_ar')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <input type="hidden" name="lat" class="form-control" id="us3-lat" value="{{ $shops[0]->delivery_pickup_latitude}}" />
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            loadMap({{ $shops[0]->delivery_pickup_latitude}}, {{ $shops[0]->delivery_pickup_longitude}})
        });
    </script>
@endsection
